...
public class MailingUtilsTest {
	...
	//
	// long dailyRecipientsBefore =
	// userProfileDAO.dailyRecipientsCount(startTime.getTime());
	//
	// mailingUtils.newsletterSender();
	// long dailyRecipientsAfter =
	// userProfileDAO.dailyRecipientsCount(startTime.getTime());
	//
	// assertEquals("no emails should be sent if newsletter date has not been
	// reached yet", dailyRecipientsBefore,
	...
	// Integer.parseInt(properties.getProperty("newsletter.batch.size")),
	// dailyRecipientsAfter
	...
	// UserProfile user = userProfileDAO.findByField("email",
	// "daniel.farkas0@gmail.com");
	// user.setNewsletterSendingDate(null);
	// userProfileDAO.merge(user);
	//
	// long dailyUndeliverablesBefore =
	// userProfileDAO.dailyUndeliverablesCount();
	//
	// mailingUtils.newsletterSender();
	// long dailyUndeliverablesAfter =
	// userProfileDAO.dailyUndeliverablesCount();
	//
	// assertEquals("unexpected number of undeliverables",
	// dailyUndeliverablesBefore - 1, dailyUndeliverablesAfter);
	// }
	...
	// userProfileDAO.dailyRecipientsCount(startTime.getTime());
	//
	// assertEquals("unexpected number of sent emails", 1, dailyRecipientsAfter
	// - dailyRecipientsBefore);
	// }
	...
	// long dailyRecipientsBefore =
	// userProfileDAO.dailyRecipientsCount(startTime.getTime());
	// assertEquals("unexpected number of initial recipients", 0,
	// dailyRecipientsBefore);
	// Long offset;
	// for (int i = 0; i < 168; i++) {
	...
	// long dailyRecipientsAfter =
	// userProfileDAO.dailyRecipientsCount(startTime.getTime());
	// assertEquals("unexpected number of end recipients", 0,
	// dailyRecipientsAfter);
	// }
