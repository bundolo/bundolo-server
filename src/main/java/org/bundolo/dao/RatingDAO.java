...
public class RatingDAO extends JpaDAO<Long, Rating> {
	...
	public void resetHistoricalRatings(String authorUsername) {
		...
		resetHistoricalRatingsQueryString.append(
				" (select parent_content_id, value from rating r1 where r1.author_username is null and r1.kind='general') as general_rating");
		...
		Query ratingsQuery = entityManager.createNativeQuery(resetHistoricalRatingsQueryString.toString(),
				Rating.class);
