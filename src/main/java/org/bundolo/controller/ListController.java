...
public class ListController {
	...
	// TODO investigate returning ResponseEntity<List<Connection>> instead of
	// List<Connection>
	...
	public @ResponseBody List<Connection> connections(@RequestParam(required = false, defaultValue = "0") Integer start,
	...
	@RequestMapping(value = { Constants.REST_PATH_CONTESTS, Constants.REST_PATH_CONTESTS + Constants.BOT_REQUEST_SUFFIX,
			Constants.REST_PATH_CONTESTS + Constants.BOT_REQUEST_SUFFIX_ESCAPED }, method = RequestMethod.GET)
	public @ResponseBody List<Contest> contests(@RequestParam(required = false, defaultValue = "0") Integer start,
			@RequestParam(required = false, defaultValue = "0") Integer end,
			@RequestParam(required = false) String orderBy, @RequestParam(required = false) String filterBy) {
		List<String> orderByColumns = new ArrayList<String>();
		List<String> orderByDirections = new ArrayList<String>();
		...
		if (StringUtils.isNotBlank(filterBy)) {
			...
			for (int i = 0; i < params.length; i += 2) {
				...
				filterByColumns.add(
						getFilterByColumn(contestColumnType.getColumnName(), contestColumnType.getColumnDataType()));
				filterByTexts.add(params[i + 1]);
			}
		}
	...
	public @ResponseBody List<User> authors(@RequestParam(required = false, defaultValue = "0") Integer start,
			@RequestParam(required = false, defaultValue = "0") Integer end,
			@RequestParam(required = false) String orderBy, @RequestParam(required = false) String filterBy) {
		List<String> orderByColumns = new ArrayList<String>();
		List<String> orderByDirections = new ArrayList<String>();
		...
		if (StringUtils.isNotBlank(filterBy)) {
			...
			for (int i = 0; i < params.length; i += 2) {
				...
				filterByColumns
						.add(getFilterByColumn(authorColumnType.getColumnName(), authorColumnType.getColumnDataType()));
				filterByTexts.add(params[i + 1]);
			}
		}
	...
	public @ResponseBody List<Content> texts(@RequestParam(required = false, defaultValue = "0") Integer start,
			@RequestParam(required = false, defaultValue = "0") Integer end,
			@RequestParam(required = false) String orderBy, @RequestParam(required = false) String filterBy) {
		List<String> orderByColumns = new ArrayList<String>();
		List<String> orderByDirections = new ArrayList<String>();
		...
		if (StringUtils.isNotBlank(filterBy)) {
			...
			for (int i = 0; i < params.length; i += 2) {
				...
				filterByColumns
						.add(getFilterByColumn(textColumnType.getColumnName(), textColumnType.getColumnDataType()));
				filterByTexts.add(params[i + 1]);
			}
		}
	...
	public @ResponseBody List<Content> announcements(@RequestParam(required = false, defaultValue = "0") Integer start,
			@RequestParam(required = false, defaultValue = "0") Integer end,
			@RequestParam(required = false) String orderBy, @RequestParam(required = false) String filterBy) {
		List<String> orderByColumns = new ArrayList<String>();
		List<String> orderByDirections = new ArrayList<String>();
	...
	public @ResponseBody List<Content> serials(@RequestParam(required = false, defaultValue = "0") Integer start,
			@RequestParam(required = false, defaultValue = "0") Integer end,
			@RequestParam(required = false) String orderBy, @RequestParam(required = false) String filterBy) {
		List<String> orderByColumns = new ArrayList<String>();
		List<String> orderByDirections = new ArrayList<String>();
		...
		if (StringUtils.isNotBlank(filterBy)) {
			...
			for (int i = 0; i < params.length; i += 2) {
				...
				filterByColumns
						.add(getFilterByColumn(serialColumnType.getColumnName(), serialColumnType.getColumnDataType()));
				filterByTexts.add(params[i + 1]);
			}
		}
	...
	public @ResponseBody List<Content> topics(@RequestParam(required = false, defaultValue = "0") Integer start,
			@RequestParam(required = false, defaultValue = "0") Integer end,
			@RequestParam(required = false) String orderBy, @RequestParam(required = false) String filterBy) {
		List<String> orderByColumns = new ArrayList<String>();
		List<String> orderByDirections = new ArrayList<String>();
		...
		if (StringUtils.isNotBlank(filterBy)) {
			...
			for (int i = 0; i < params.length; i += 2) {
				...
				filterByColumns
						.add(getFilterByColumn(topicColumnType.getColumnName(), topicColumnType.getColumnDataType()));
				filterByTexts.add(params[i + 1]);
			}
		}
	...
	@RequestMapping(value = { Constants.REST_PATH_COMMENTS, Constants.REST_PATH_COMMENTS + Constants.BOT_REQUEST_SUFFIX,
			Constants.REST_PATH_COMMENTS + Constants.BOT_REQUEST_SUFFIX_ESCAPED }, method = RequestMethod.GET)
	public @ResponseBody List<Comment> comments(@RequestParam(required = false, defaultValue = "0") Integer start,
			@RequestParam(required = false, defaultValue = "0") Integer end,
			@RequestParam(required = false) String orderBy, @RequestParam(required = false) String filterBy) {
		List<String> orderByColumns = new ArrayList<String>();
		List<String> orderByDirections = new ArrayList<String>();
		...
		if (StringUtils.isNotBlank(filterBy)) {
			...
			for (int i = 0; i < params.length; i += 2) {
				...
				filterByColumns.add(
						getFilterByColumn(commentColumnType.getColumnName(), commentColumnType.getColumnDataType()));
				filterByTexts.add(params[i + 1]);
			}
		}
	...
	public @ResponseBody List<ItemList> itemLists(@RequestParam(required = false, defaultValue = "0") Integer start,
			@RequestParam(required = false, defaultValue = "0") Integer end,
			@RequestParam(required = false) String orderBy, @RequestParam(required = false) String filterBy) {
		List<String> orderByColumns = new ArrayList<String>();
		List<String> orderByDirections = new ArrayList<String>();
		...
		if (StringUtils.isNotBlank(filterBy)) {
			...
			for (int i = 0; i < params.length; i += 2) {
				...
				filterByColumns.add(
						getFilterByColumn(itemListColumnType.getColumnName(), itemListColumnType.getColumnDataType()));
				filterByTexts.add(params[i + 1]);
			}
		}
	...
	public @ResponseBody Object next(@RequestParam(required = true) String type,
		...
		logger.log(Level.INFO,
				"next, type: " + type + ", id: " + id + ", orderBy: " + orderBy + ", ascending: " + ascending);
		Object result = null;
		switch (type) {
		case "connection":
			result = connectionService.findNext(Long.valueOf(id), ConnectionColumnType.valueOf(orderBy).getColumnName(),
	...
	public @ResponseBody List<Content> recent(@RequestParam(required = false) Date fromDate,
			@RequestParam(required = false, defaultValue = "0") Integer limit) {
		// there is no paging of recent currently, if the performance becomes an
		// issue, reconsider
		String senderUsername = SecurityUtils.getUsername();
		if (senderUsername != null && limit == 0) {
			// if limit is not set, and user is known, set date to user previous
			// activity
	...
	public @ResponseBody List<Content> authorItems(@PathVariable String slug,
	...
	@RequestMapping(value = { Constants.REST_PATH_AUTHOR_INTERACTIONS + "/" + Constants.REST_PATH_AUTHOR
			+ "/{slug}" }, method = RequestMethod.GET)
	public @ResponseBody List<Content> authorInteractions(@PathVariable String slug,
	...
	@RequestMapping(value = { Constants.REST_PATH_ITEM_LIST_ITEMS + "/" + Constants.REST_PATH_ITEM_LIST
			+ "/{slug}" }, method = RequestMethod.GET)
	public @ResponseBody List<Content> itemListItems(@PathVariable String slug,
			@RequestParam(required = false, defaultValue = "0") Integer start,
			@RequestParam(required = false, defaultValue = "0") Integer end,
			@RequestParam(required = false) String orderBy, @RequestParam(required = false) String filterBy) {
