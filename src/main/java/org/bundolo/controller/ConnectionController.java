...
public class ConnectionController {
	...
	public @ResponseBody Connection connection(@PathVariable String slug) {
	...
	public @ResponseBody Boolean delete(@PathVariable String slug) {
		...
		return connectionService
				.deleteConnection(ContentKindType.connection_description.getLocalizedName() + "/" + slug) != null;
	}

	@RequestMapping(value = Constants.REST_PATH_CONNECTION, method = RequestMethod.POST)
	public @ResponseBody ResponseEntity<String> saveOrUpdate(@RequestBody final Connection connection) {
	...
	public @ResponseBody List<Content> connectionGroups() {
