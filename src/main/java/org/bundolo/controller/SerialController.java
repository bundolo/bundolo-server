...
public class SerialController {
	...
	public @ResponseBody Content serial(@PathVariable String slug) {
	...
	public @ResponseBody Content serialByEpisode(@PathVariable String serialSlug, @PathVariable String episodeSlug) {
		Content episode = contentService
				.findContent(ContentKindType.episode.getLocalizedName() + "/" + serialSlug + "/" + episodeSlug);
	...
	public @ResponseBody Boolean deleteSerial(@PathVariable String slug) {
	...
	public @ResponseBody ResponseEntity<String> saveOrUpdate(@RequestBody final Content serial) {
	...
	public @ResponseBody List<Content> episodes(@RequestParam(required = true) Long parentId,
	...
	public @ResponseBody Content episode(@PathVariable String serialSlug, @PathVariable String episodeSlug) {
		return contentService
				.findEpisode(ContentKindType.episode.getLocalizedName() + "/" + serialSlug + "/" + episodeSlug);
	}

	@RequestMapping(value = Constants.REST_PATH_EPISODE + "/{serialSlug}/{episodeSlug}", method = RequestMethod.DELETE)
	public @ResponseBody Boolean deleteEpisode(@PathVariable String serialSlug, @PathVariable String episodeSlug) {
		Long episodeId = contentService
				.deleteEpisode(ContentKindType.episode.getLocalizedName() + "/" + serialSlug + "/" + episodeSlug);
	...
	public @ResponseBody ResponseEntity<String> saveOrUpdateEpisode(@RequestBody final Content episode) {
