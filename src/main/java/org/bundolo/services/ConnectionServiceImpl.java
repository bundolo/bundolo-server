...
public class ConnectionServiceImpl implements ConnectionService {
	...
	public Connection findConnection(String slug) {
		...
		if (connection != null) {
			...
			Rating rating = connection.getDescriptionContent().getRating().size() > 0
					? (Rating) connection.getDescriptionContent().getRating().toArray()[0] : null;
			...
			Date lastActivity = !connection.getAuthorUsername().equals(SecurityUtils.getUsername()) || rating == null
